...
variables = {'A': 20000, 'B': 20001, 'X': 20004, 'P': 20005}
variablesValue = {20000: '5', 20001: 'A', 20002: '0', 20003: '0', 20004: 'B', 20005: 'P'}
operators = {'+', '-', '*', '/', '^'}
...
def errorCatching(x):
    if x[2] == keytable.get('LET'):
        ...
        if int(temp) not in variables.values():
            print("Line " + x[1])
            print("Token: 10028")
...
# Create Interpreter file

def create_for_interpreter():
    m = open("code 1Edited.txt", 'r')
    g = open("code 1 interpret.txt", 'w')

    for line in m:
        line1 = line.split(" ")
        if line1[2] == "LET":
            temp = line[7:]
            g.write("assignment " + temp)
        elif line1[2] == "PRINT":
            temp = line[9:]
            g.write("Print" + temp)
        elif line1[2] == "END\n":
